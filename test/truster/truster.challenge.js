...
const TrusterAttack = contract.fromArtifact("TrusterAttack");
...
describe("[Challenge] Truster", function () {
	...
	it("Exploit Attack", async function () {
		...
		this.attackerContract = await TrusterAttack.new({ from: deployer });
		await this.attackerContract.attack(this.pool.address, this.token.address, {
			from: attacker,
		});
	});
